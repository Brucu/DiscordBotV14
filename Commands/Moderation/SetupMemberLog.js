...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addChannelOption((options) => options
            .setName("log_channel")
            .setDescription("Select loggin channel for this system.")
            .addChannelTypes(ChannelType.GuildText)
            .setRequired(true)
        )
        .addRoleOption((options) => options
            .setName("member_role")
            .setDescription("Set the role to be automatically added to new member.")
        )
        .addRoleOption((options) => options
            .setName("bot_role")
    ...
    async execute(interaction, client) {
        ...
        const Embed = new EmbedBuilder()
            ...
            .setDescription([
                ...
                `- Member Auto-Role Updated ${memberRole ? `<@&${memberRole}>` : "None Specified."}`,
